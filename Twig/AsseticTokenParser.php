...
class AsseticTokenParser extends BaseAsseticTokenParser
{
    ...
    protected function createBodyNode(AssetInterface $asset, TwigNode $body, array $inputs, array $filters, $name, array $attributes = array(), $lineno = 0, $tag = null)
    {
        return new AsseticNode($asset, $body, $inputs, $filters, $name, $attributes, $lineno, $tag);
    }

    protected function createNode(AssetInterface $asset, TwigNode $body, array $inputs, array $filters, $name, array $attributes = array(), $lineno = 0, $tag = null)
    {
        return new AsseticNode($asset, $body, $inputs, $filters, $name, $attributes, $lineno, $tag);
    }
}
